...
{{--                            <div class="ml-4 mt-2">--}}
{{--                                <label class="rdiobox">--}}
{{--                                    <input name="radioBtn" type="radio" value="1" id="radioBtn" checked>--}}
{{--                                    <span> بحث بنوع الفاتورة </span>--}}
{{--                                </label>--}}
{{--                            </div>--}}
{{--                            <div class="ml-4 mt-2">--}}
{{--                                <label class="rdiobox">--}}
{{--                                    <input name="radioBtn" value="2" type="radio">--}}
...
{{--                        </div>--}}
                        ...
                        <div class="d-flex justify-content-start flex-wrap gap-4">
                            ...
                            <div class="col-lg-3 mt-3" id="type_invoice">
                                <p class="mg-b-10"> تحديد نوع الفواتير </p>
                                <select class="form-control select2-no-search" name="type_invoice">
                                    <option value="{{ $typeInvoice ?? 'حدد نوع الفواتير' }}"
                                            disabled selected> {{ $typeInvoice ?? 'حدد نوع الفواتير' }} </option>
