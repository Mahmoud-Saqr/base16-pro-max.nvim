...
{{--						</div>--}}
						<div class="user-info">
							<h4 class="font-weight-semibold mb-1 text-primary">{{ Auth::user() -> name }}</h4>
							<span class="mb-0 text-muted">{{ Auth::user() -> email }}</span>
						</div>
					</div>
				</div>
				<ul class="side-menu">
					<li class="side-item side-item-category">برنامح فواتير</li>
					<li class="slide">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='part_of_paid_invoices') }}">الفواتير المدفوعة جزئياً</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='report_invoices') }}">تقارير الفواتير</a></li>
