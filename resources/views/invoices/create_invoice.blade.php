                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col">
                                ...
                                <select name="select_section" class="form-control select2-no-search" onclick="console.log($(this).val())"
                                    ...
                                    <option label="placeholder" selected disabled> __حدد القسم__ </option>
                            ...
                            <div class="col">
                                ...
                                <select id="product" name="product" class="form-control select2-no-search" required>
                                    <option label="placeholder" selected disabled> __المنتج__ </option>
                                </select>
                            </div>
                        ...
                        <div class="row mt-3">
                            <div class="col">
                                ...
                                <select name="rateVAT" id="rateVAT" class="form-control select2-no-search" onchange="myFunction()" required>
                                    <option label="placeholder" selected disabled> __حدد النسبة__ </option>
