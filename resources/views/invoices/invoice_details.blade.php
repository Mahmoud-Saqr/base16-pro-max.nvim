                                                ...
                                                <div class="card-body">
                                                    <div class="invoice-header justify-content-end">
                                                        <div class="billed-from">
                                                            ...
                                                            <p>تاريخ الاضافة: <span class="text-primary mr-1"> {{ date('d-m-Y') }} </span></p>
                                                            <p>وقت الاضافة: <span class="text-primary mr-1"> {{ date('h:m:s') }} </span></p>
                                                            <p> تمت الاضافة بواسطة: <span class="text-primary mr-1">{{ Auth::user() -> name }}</span></p>
